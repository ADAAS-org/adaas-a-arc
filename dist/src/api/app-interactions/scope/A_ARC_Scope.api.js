...
exports.A_ARC_APP_INTERACTIONS__ScopeAPI = void 0;
const a_auth_1 = require("@adaas/a-auth");
/**
 * API Provider for Scopes
 */
class A_ARC_APP_INTERACTIONS__ScopeAPI extends a_auth_1.A_AUTH_AppInteractions_APIProvider {
    constructor() {
        super(...arguments);
    ...
    */
    ...
    meta) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this
                .post(`/scopes/${request.aseid}`, request, {
                meta
            });
        });
    }
}
exports.A_ARC_APP_INTERACTIONS__ScopeAPI = A_ARC_APP_INTERACTIONS__ScopeAPI;
