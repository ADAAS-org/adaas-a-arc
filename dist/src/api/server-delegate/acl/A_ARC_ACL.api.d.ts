...
export declare class A_ARC_SERVER_DELEGATE__ACLAPI extends A_AUTH_ServerCommands_APIProvider<A_ARC_ContextClass> {
     ...
     * @returns
     */
    verify<M = any>(request: A_ARC_SERVER_DELEGATE_TYPES__ACLVerifyRequest, 
    /**
     * The meta object to pass through API call for error handling or response handling
     */
    meta?: M): Promise<A_ARC_SERVER_DELEGATE_TYPES__ACLVerifyResponse>;
    /**
     ...
     * @returns
     */
    remove<M = any>(request: A_ARC_SERVER_DELEGATE_TYPES__ACLRemoveRequest, 
    /**
     * The meta object to pass through API call for error handling or response handling
     */
