...
export declare const ACL: A_ARC_SERVER_DELEGATE__ACLAPI;
export declare const Resource: A_ARC_SERVER_DELEGATE__ResourceAPI;
export declare const Scope: A_ARC_SERVER_DELEGATE__ScopeAPI;
export declare const Permission: A_ARC_SERVER_DELEGATE__PermissionAPI;
