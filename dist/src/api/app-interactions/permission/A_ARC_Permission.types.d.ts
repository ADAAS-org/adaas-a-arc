...
export type A_ARC_APP_INTERACTIONS_TYPES__PermissionListResponse = A_SDK_TYPES__IDefaultPagination<A_SDK_TYPES__Required<A_SDK_TYPES__DeepPartial<A_ARC_TYPES__Permission_APIEntity>, [
    'aseid',
    'code',
    'name',
    'icon',
...
export type A_ARC_APP_INTERACTIONS_TYPES__PermissionGetResponse = A_SDK_TYPES__IDefaultPagination<A_SDK_TYPES__Required<A_SDK_TYPES__DeepPartial<A_ARC_TYPES__Permission_APIEntity>, [
    'aseid',
    'code',
    'name',
    'icon',
